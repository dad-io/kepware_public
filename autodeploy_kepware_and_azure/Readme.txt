...
Dependencies:
- Azure CLI 2.x.x
- Azure CLI IoT Extension (use the CLI to run 'az extension add --name azure-cli-iot-ext')
- Python 3.7 or above
...
- Assignment of user parameters is conducted through 'setup.json'
...
Review 'createNewAsset.py' for procedural details